...
def methodTwo(context,emailid):
    context.eid = emailid        #store the value in parameter
...
def methodFour(context):
    print("L5 - Home Page opened {}".format(context.eid))     #use the value inside steps which is stored in above method
